...
(function($) {
  ...
  var dict = {
    ...
    "single": {
      ...
      es: "Este Checkbox es requerido"
    },
    "currency": {
      en: "Invalid monetary value",
      es: "Valor monetario invalido"
    },
    "email": {
      en: "Invalid email address",
      es: "Correo electronico invalido"
    },
    "url": {
      en: "Invalid URL",
      es: "URL invalida"
    ...
    "alphanumeric": {
      en: "Use digits and letters only",
      es: "Usar digitos y letras solamente"
    },
    "street_number": {
      en: "Street Number only",
      es: "Solamente numero de calle"
    },
    "character": {
      en: "Use letters only",
    ...
    "charactercomma": {
      en: "Use letters, space or comma only",
      es: "Usar letras, espacio o espacio solamente "
    },
    "number": {
      en: "Use digits only",
      es: "Usar digitos solamente"
    },
    "numberSpace": {
      en: "Use digits and spaces only",
      es: "Usar digitos y espacio solamente"
    },
    "postcode": {
      en: "Invalid postcode",
      es: "Codigo postal invalido"
    },
    "date": {
      en: "Invalid date",
      es: "Fecha invalida"
    ...
    "phone_2": {
      en: "Must be 10 digits long",
      es: "El numero debe tener 10 digitos de longitud"
    },
    "size_1": {
      en: "Must be {0} characters",
      es: "Debe tener {0} caracteres"
    },
    "size_2": {
      en: "Must be between {0} and {1} characters",
      es: "Debe tener entre {0} y {1} caracteres"
    },
    "min": {
    ...
    "max": {
      ...
      es: "Debe tener un maximo de {0} caracteres"
    },
    "decimal": {
      en: "Invalid decimal value",
      es: "Valor decimal invalido"
    },
    "minVal": {
      en: "Must be greater than " ,
      es: "Debe ser mayor de "
    },
    "maxVal": {
      en: "Must be less than ",
      es: "Debe ser menor que "
    },
    "rangeVal": {
      en: "Must be between ",
      es: "Debe estar entre "
    ...
    "image": {
      ...
      es: "El formato del archivo no esta soportado"
    },
    "agreement": {
      en: "You must agree to continue",
      es: "Usted debe aceptar para continuar"
    },
    "minAge": {
      en: "You must be at least ",
      es: "Usted debe tener al menos "
    },
    "startDate": {
      en: "Invalid Start Date",
      es: "Fecha de inicio invalida"
    },
    "endDate": {
      en: "Invalid End Date",
    ...
    "password_number": {
      ...
      es: "La contraseña debe contener al menos un numero (0-9)"
    },
    "password_lower": {
      en: "Password must contain at least one lowercase letter (a-z)",
      es: "La contraseña debe contener al menos una letra minuscula (a-z)"
    },
    "password_upper": {
      en: "Password must contain at least one uppercase letter (A-Z)",
      es: "La contraseña debe contener al menos una letra mayuscula (A-Z)"
    }
  }
  ...
  $.verify.addFieldRules({
    ...
    street_number: {
      ...
      message: dict["street_number"][language]
    },
    number: {
      regex: /^\d+$/,
      message: dict["number"][language]
    },
    numberSpace: {
      regex: /^[\d\ ]+$/,
      message: dict["numberSpace"][language]
    },
    image: {
      regex: /(\.jpg|\.jpeg|\.bmp|\.gif|\.png)$/,
      message: dict["image"][language]
    },
    postcode: {
      regex: /^\d{4}$/,
      message: dict["postcode"][language]
    },
    date: {
      fn: function(r) {
    ...
    min: function(r) {
      ...
      if(v.length < min)
        return String.format(dict["min"][language], min);
      return true;
    },
    max: function(r) {
    ...
    minAge: function(r){
      ...
      if(fieldDate === "Invalid Date")
        return dict["date"][language];
      if(fieldDate > minDate)
        return dict["minAge"][language] + age;
      return true;
    }
  });
  ...
  $.verify.addGroupRules({
    ...
    dateRange: function(r) {
      ...
      if(!startDate)
        return dict["startDate"][language];

      var endDate = $.verify.utils.parseDate(end.val());
      if(!endDate)
        return dict["endDate"][language];

      if(startDate >= endDate)
        return dict["difDate"][language];
