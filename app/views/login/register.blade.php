...
@section('title', Lang::get('login_title.register'))
@section('content')
				...
				<div class="register-box clearfix animated flipInY">
					...
					<ul class="tabs">
						<li class="tab-link current" data-tab="tab-1">
							{{Lang::get('register_student.register_student')}}
						</li>
						<li class="tab-link" data-tab="tab-2">
							{{Lang::get('register_student.register_university')}}
						</li>
					</ul>
						...
						{{ Form::open(array(
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_name">
									{{Lang::get('register_student.first_name')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_lastname">
									{{Lang::get('register_student.last_name')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_email">
									{{Lang::get('register_student.email')}}
								</label>
								<input data-validate="required,email" type="text" class="form-control" id="guest_email" name="guest_email" placeholder="{{Lang::get('register_student.email_placeholder')}}"  />
							</div>
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_genre">
									{{Lang::get('register_student.genre')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_job">
									{{Lang::get('register_student.has_a_job')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="guest_id">
									{{Lang::get('register_student.id_number')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="user_password">
									{{Lang::get('register_student.password')}}
								</label>
							...
							<div class="form-group col-xs-12 col-sm-6">
								<label for="user_confirm_password">
									{{Lang::get('register_student.confirm_password')}}
								</label>
							...
							<button type="submit" class="btn btn-red">
								{{Lang::get('register_student.register')}}
							</button> 
						{{ Form::close() }}   		
					</div> 
						...
						{{ Form::open(array(
							...
							<div class="form-group col-lg-12">
								<label for="university_name">
									{{Lang::get('register_university.name')}}
								</label>
							...
							<div class="form-group col-lg-12">
								<label for="university_acronym">
									{{Lang::get('register_university.acronym')}}
								</label>
							...
							<div class="form-group col-lg-12">
								<label for="university_email">
									{{Lang::get('register_university.email')}}
								</label>
							...
							<div class="form-group col-lg-12">
								<label for="university_password">
									{{Lang::get('register_university.password')}}
								</label>
							...
							<div class="form-group col-lg-12">
								<label for="university_confirm_password">
									{{Lang::get('register_university.confirm_password')}}
								</label>
