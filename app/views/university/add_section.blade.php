                        ...
                        <div class="col-lg-12">
                            {{ Form::open(array('url' => Lang::get('routes.add_section'), 'id' => 'register_form', 'role' => 'form')) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input data-validate="required,size(4, 30),charactercomma,validateSection,compareCodes(section, codes)" class="form-control" id="section" name="section" placeholder="{{Lang::get('add_subject.section_placeholder')}}">
