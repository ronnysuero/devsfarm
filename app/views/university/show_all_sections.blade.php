...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-list"></i> {{Lang::get('list_section.section')}}</h1>
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => Lang::get('routes.update_section'), 'id' => 'register_form', 'role' => 'form')) }}
                        <div class="form-group">
                            ...
                            <input data-validate="required,size(4, 30),charactercomma,validateSection,compareCodes(section_code, codes)" class="form-control" id="section_code" name="section_code">
                        </div>
