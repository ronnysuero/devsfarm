...
@section('title', Lang::get('university_title.add_subject'))
@section('content')
	<div class="row">
		<div class="col-lg-12">
								...
								<div class="col-lg-12">
									{{ Form::open(array('url' => Lang::get('routes.add_subject'), 'id' => 'register_form', 'role' => 'form')) }}
										<div class="form-group">
											...
											<input data-validate="required,size(5, 25),characterspace" class="form-control" id="subject_name" name="subject_name" placeholder="{{Lang::get('add_subject.name_placeholder')}}">
										</div>
										<div class="form-group">
