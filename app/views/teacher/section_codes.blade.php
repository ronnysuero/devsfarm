...
@section('content')
	@if (count($section_codes) > 0)
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa-list"></i> 
				{{Lang::get('section_codes.all_section_codes')}}</h1>
			</div>
			<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header"><i class="fa fa-plus"></i> 
			{{Lang::get('section_codes.new_section_code')}}</h1>
		</div>
		<div class="col-lg-12">
		...
		$('document').ready(function()
		{
			...
			$("#section").on("change", function()
			{
				if($('#section').val() !== "") 
				{
					...
					$('#code').text(subject_name + section_name + current_period_txt);
				}
			});
