        ...
        <ul class="nav navbar-top-links navbar-right user-menu" id="user-menu">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu inbox dropdown-user">
                    ...
                    @endforeach
                    <li><a href="{{Lang::get('routes.inbox')}}" class="btn bg-primary">{{Lang::get('teacher_master.view')}}</a></li>
                </ul>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="{{Lang::get('routes.teacher_profile')}}"><i class="fa fa-user fa-fw" ></i> {{Lang::get('teacher_master.profile')}}</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="{{Lang::get('routes.inbox')}}"><i class="fa fa-envelope"></i>   {{Lang::get('teacher_master.inbox')}}</a></li>
                    <li class="divider"></li>
                    <li><a href="{{Lang::get('routes.logout')}}"><i class="fa fa-sign-out fa-fw text-danger" ></i> {{Lang::get('teacher_master.logout')}}</a>
                    </li>
                </ul>
            </li>
        </ul>
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li>
							<a href="{{Lang::get('routes.teacher')}}" class="nav_home_categoria"  style="background-color: #0097A7; color: white;"><i class="fa fa-home"></i> {{Lang::get('teacher_master.board')}}</a>
						</li>
						<li>
                        ...
                        <li><a href="{{Lang::get('routes.section_codes')}}" style="background-color: #0097A7; color: white; font-weight: bold;">{{Lang::get('teacher_master.section_codes')}}</a>
                        </li>
					</ul>
				</div>
			</div>
